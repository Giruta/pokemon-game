...
const App = () => {
  return (
    <>
      ...
      >
        <p>Triple Triad is played on a three-by-three (3*3) square grid of blank space</p>
        <p>In a basic game each player has five cards. A coin flip decided who begins.</p>
        <p>To win, a majority of the total ten cards played (including the one card)</p>
      </Layout>
      <Footer />
    </>
  );
